    ...
    for (const url of urls) {
      try {
        ...
        if (process.env.BASELINE === 'true') {
          pageUrl = process.env['BASE_SDL'] + url
        }
        ...
        page.context().addCookies([
          {
            ...
            value: 'test-proposal',
            path: '/',
            domain: 'sqe-se-web-platform-enterprise.vercel.app'
          }
        ])
        page.context().addCookies([
          {
            ...
            value: 'test-proposal',
            path: '/',
            domain: 'pre-se-web-platform-enterprise.vercel.app'
          }
        ])
        page.context().addCookies([
          {
            ...
            value: 'test-proposal',
            path: '/',
            domain: 'se-web-platform-enterprise.vercel.app'
          }
        ])
